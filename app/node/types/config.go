...
// the genesis block
func NewGenesisConfig(l1Hash common.Hash, l1Number uint64) *rollup.Genesis {
...
func NewBlockInfo(hash, parentHeash common.Hash, number, time uint64) eth.BlockInfo {
