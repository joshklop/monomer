...
import (
	...
	appmodule "app/x/app"
	appmodulekeeper "app/x/app/keeper"
	appmoduletypes "app/x/app/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "app/app/params"
	"app/docs"
)
...
func New(
	...
	*/
	...
	app.AppKeeper = *appmodulekeeper.NewKeeper(
		appCodec,
		keys[appmoduletypes.StoreKey],
		keys[appmoduletypes.MemStoreKey],
		app.GetSubspace(appmoduletypes.ModuleName),
	)
	appModule := appmodule.NewAppModule(appCodec, app.AppKeeper, app.AccountKeeper, app.BankKeeper)
