...
var fileDescriptor_00dc24396718b2df = []byte{
	...
	0xc8, 0x8d, 0x8b, 0xcb, 0x37, 0xb1, 0x20, 0x38, 0xb5, 0xa8, 0x2c, 0x33, 0x39, 0x55, 0xc8, 0x82,
	0x8b, 0x39, 0x38, 0xb5, 0x44, 0x48, 0x4c, 0x0f, 0x61, 0x8d, 0x1e, 0xc2, 0x0e, 0x29, 0x71, 0x0c,
	0x71, 0x88, 0x29, 0x4a, 0x0c, 0x4e, 0x12, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8,
	0xe0, 0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x17, 0x1e, 0xcb, 0x31, 0xdc, 0x78, 0x2c, 0xc7,
	0x90, 0xc4, 0x06, 0x76, 0xb9, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x9b, 0xa6, 0x5f, 0x3f, 0xd1,
	0x00, 0x00, 0x00,
}
...
func NewMapServiceClient(cc grpc1.ClientConn) MapServiceClient {
...
func (c *mapServiceClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*SetResponse, error) {
	out := new(SetResponse)
	err := c.cc.Invoke(ctx, "/testapp.v1.MapService/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMapServiceServer) Set(ctx context.Context, req *SetRequest) (*SetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Set not implemented")
}

func RegisterMapServiceServer(s grpc1.Server, srv MapServiceServer) {
...
func _MapService_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testapp.v1.MapService/Set",
	}
